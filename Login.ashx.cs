    ...
    public class Login : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (!string.IsNullOrEmpty(action))
            {
                ...
                {
                    int b = (int)SqlHelper.ExecuteScalar("select Count(*) from HY where U_ACCOUNT=@userName"
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        DataTable dt = SqlHelper.ExecuteDataTable("select * from HY where U_PSW=@password and U_ACCOUNT=@userName"
